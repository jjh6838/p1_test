...
#SBATCH --output=outputs_per_country/logs/siting_22_%j.out
#SBATCH --error=outputs_per_country/logs/siting_22_%j.err
...
echo "[INFO] Processing 10 countries in this batch: SDN, SEN, SGP, SLE, SLV, SOM, SRB, SSD, SUR, SVK"
