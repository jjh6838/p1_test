...
$PY process_country_siting.py NGA
if [ $? -eq 0 ]; then
...
$PY process_country_siting.py NIC
if [ $? -eq 0 ]; then
...
$PY process_country_siting.py NLD
if [ $? -eq 0 ]; then
...
$PY process_country_siting.py NOR
if [ $? -eq 0 ]; then
...
$PY process_country_siting.py NPL
if [ $? -eq 0 ]; then
...
$PY process_country_siting.py NZL
if [ $? -eq 0 ]; then
...
$PY process_country_siting.py OMN
if [ $? -eq 0 ]; then
...
$PY process_country_siting.py PAK
if [ $? -eq 0 ]; then
...
$PY process_country_siting.py PAN
if [ $? -eq 0 ]; then
...
$PY process_country_siting.py PER
if [ $? -eq 0 ]; then
