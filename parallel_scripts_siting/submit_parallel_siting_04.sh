...
#SBATCH --output=outputs_global/logs/siting_04_%j.out
#SBATCH --error=outputs_global/logs/siting_04_%j.err
#SBATCH --mail-type=END,FAIL

set -euo pipefail
cd "$SLURM_SUBMIT_DIR"

echo "[INFO] Starting siting analysis script 4/24 (T2) at $(date)"
...
echo "[INFO] Siting batch 4/24 (T2) completed at $(date)"
