...
def combine_global_results(input_dir="outputs_per_country", output_file="global_supply_analysis.parquet"):
    """Combine all country results into a single global dataset"""
    ...
    print(f"Combined dataset: {len(global_df)} total records from {len(all_data)} countries")
