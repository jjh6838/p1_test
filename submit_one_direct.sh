...
TIER_1="CHN"
TIER_2="USA BRA IND DEU FRA"
TIER_3="AUS CAN SAU KAZ IDN ZAF MEX RUS IRN EGY ARG"
TIER_4="GHA COL UKR JPN PAK MLI DZA NOR SWE MMR PER PHL TCD VEN ETH GEO NGA IRQ SDN TUR"
