...
TIER_1="CHN"
TIER_2="FRA BRA USA DEU IND"
TIER_3="RUS CAN IDN ARG SAU IRN EGY KAZ ZAF MEX AUS"
TIER_4="JPN GEO ETH COL SWE IRQ NOR TUR PAK MMR PHL NGA UKR PER GHA SDN TCD VEN DZA MLI"
