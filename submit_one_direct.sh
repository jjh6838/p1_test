...
TIER_1="CHN"
TIER_2="DEU BRA IND USA FRA"
TIER_3="AUS KAZ IDN IRN CAN RUS ZAF MEX SAU ARG EGY"
TIER_4="TCD TUR MLI PAK PHL JPN GEO MMR ETH UKR PER NOR IRQ COL DZA GHA SDN VEN SWE NGA"
