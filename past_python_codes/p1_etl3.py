...
print(korea_boundary['NAME_1'].unique())

# Filter the boundary data to include only "Incheon"
regions_of_interest = ['Busan', 'Chungcheongbuk-do', 'Chungcheongnam-do',
 'Daegu', 'Daejeon', 'Gangwon-do', 'Gwangju', 'Gyeonggi-do', 'Gyeongsangbuk-do', 
