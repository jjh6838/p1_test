...
echo "  Other (smallest):  8 countries/script | Short partition (12h)      | 64G, 40 CPUs"
echo "  Tier 3 (medium):   4 countries/script | Short partition (12h)      | 64G, 40 CPUs"
echo "  Tier 2 (large):    2 countries/script | Medium partition (48h/2d)  | 64G, 40 CPUs"  
echo "  Tier 1 (largest):  1 country/script  | Medium partition (48h/2d)  | 64G, 40 CPUs"
