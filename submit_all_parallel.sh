...
echo "  Tier 1 (biggest): 1 country/script, 340G, 72 CPUs, partition=Medium, time=48:00:00"
echo "  Tier 2 (large):   2 countries/script, 340G, 72 CPUs, partition=Medium, time=48:00:00"  
echo "  Tier 3 (medium):  4 countries/script, 340G, 72 CPUs, partition=Short,  time=12:00:00"
echo "  Other (small):    8 countries/script, 340G, 72 CPUs, partition=Short,  time=12:00:00"
echo ""
