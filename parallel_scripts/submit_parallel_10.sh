...
$PY process_country_supply.py IRN --output-dir outputs_per_country $SCENARIO_FLAG
if [ $? -eq 0 ]; then
...
$PY process_country_supply.py KAZ --output-dir outputs_per_country $SCENARIO_FLAG
if [ $? -eq 0 ]; then
