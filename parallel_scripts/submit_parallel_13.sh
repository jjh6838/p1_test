...
echo "[INFO] Starting parallel script 13/40 (T2) at $(date)"
echo "[INFO] Processing 1 countries in this batch: SDN"
...
$PY process_country_supply.py SDN --output-dir outputs_per_country $SCENARIO_FLAG
if [ $? -eq 0 ]; then
...
echo "[INFO] Batch 13/40 (T2) completed at $(date)"
