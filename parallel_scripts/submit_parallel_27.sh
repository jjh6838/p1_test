...
$PY process_country_supply.py ZMB --output-dir outputs_per_country $SCENARIO_FLAG
if [ $? -eq 0 ]; then
...
$PY process_country_supply.py ZWE --output-dir outputs_per_country $SCENARIO_FLAG
if [ $? -eq 0 ]; then
