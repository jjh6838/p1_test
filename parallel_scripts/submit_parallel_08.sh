...
$PY process_country_supply.py ARG --output-dir outputs_per_country $SCENARIO_FLAG
if [ $? -eq 0 ]; then
...
$PY process_country_supply.py COD --output-dir outputs_per_country $SCENARIO_FLAG
if [ $? -eq 0 ]; then
