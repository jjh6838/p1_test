...
$PY process_country_supply.py MRT --output-dir outputs_per_country $SCENARIO_FLAG
if [ $? -eq 0 ]; then
...
$PY process_country_supply.py MYS --output-dir outputs_per_country $SCENARIO_FLAG
if [ $? -eq 0 ]; then
...
$PY process_country_supply.py NER --output-dir outputs_per_country $SCENARIO_FLAG
if [ $? -eq 0 ]; then
...
$PY process_country_supply.py NGA --output-dir outputs_per_country $SCENARIO_FLAG
if [ $? -eq 0 ]; then
