...
echo "[INFO] Starting parallel script 38/40 (T1) at $(date)"
...
$PY process_country_supply.py CAN --output-dir outputs_per_country
if [ $? -eq 0 ]; then
...
echo "[INFO] Batch 38/40 (T1) completed at $(date)"
