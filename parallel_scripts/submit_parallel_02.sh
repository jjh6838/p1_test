...
#SBATCH --output=outputs_per_country/logs/parallel_02_%j.out
#SBATCH --error=outputs_per_country/logs/parallel_02_%j.err
#SBATCH --mail-type=END,FAIL

set -euo pipefail
cd "$SLURM_SUBMIT_DIR"

echo "[INFO] Starting parallel script 2/40 (T2) at $(date)"
