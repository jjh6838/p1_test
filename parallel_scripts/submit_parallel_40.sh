...
echo "[INFO] Starting parallel script 40/40 (T1) at $(date)"
echo "[INFO] Processing 3 countries in this batch: IND, RUS, USA"
...
$PY process_country_supply.py IND --output-dir outputs_per_country
if [ $? -eq 0 ]; then
...
echo "[INFO] Batch 40/40 (T1) completed at $(date)"
