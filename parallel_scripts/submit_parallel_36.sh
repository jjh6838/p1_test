...
if $PY process_country_supply.py NER --output-dir outputs_per_country; then
...
if $PY process_country_supply.py NIC --output-dir outputs_per_country; then
...
if $PY process_country_supply.py NLD --output-dir outputs_per_country; then
...
if $PY process_country_supply.py NPL --output-dir outputs_per_country; then
...
if $PY process_country_supply.py NZL --output-dir outputs_per_country; then
...
if $PY process_country_supply.py OMN --output-dir outputs_per_country; then
...
if $PY process_country_supply.py PAN --output-dir outputs_per_country; then
...
if $PY process_country_supply.py PNG --output-dir outputs_per_country; then
...
if $PY process_country_supply.py POL --output-dir outputs_per_country; then
...
if $PY process_country_supply.py PRI --output-dir outputs_per_country; then
